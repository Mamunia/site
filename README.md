This website is created by using Yen-Chia Hsu's awesome static html template. 
The following information may be helpful to someone who wishes to build github pages using this template.
